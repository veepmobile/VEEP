...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="profile">
    ...
    <xsl:if test="colleg[position()=last()]">
      <span class="subcaption">Члены коллегиального исполнительного органа</span>
    ...
    <script language="javascript" type="text/javascript">
      ...
      function goPeriod(period){
        showClock();
        $("#tab_content").load("/Tab/Index/?id=20&ticker=]]><xsl:value-of select="//@iss"/><![CDATA[&period=" + period, 
            function(data){
                hideClock();
            }
        );
