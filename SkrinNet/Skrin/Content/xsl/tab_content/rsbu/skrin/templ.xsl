...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
      ...
      <xsl:if test="//cons/@val=1">
        ...
        <td>
          <input type="radio" name="currency">
            ...
            <xsl:attribute name="onclick">
              goform(<xsl:value-of select="//ed/@val"/>,'<xsl:value-of select="//@iss"/>');
            </xsl:attribute>
          </input>
    ...
    set_xls_function(function () {
           if (!getObj("reports")) {
            ...
            iframepost({"id": $("#tab_id").val(), "curr":$("#curr_selector").find("input:radio:checked").val(), "ticker":$("#iss").val(),"per" :getYears(),"cons" : $("#fn").val(), "xls" : "1"}, "/Tab/", "reports");
        });
      ...
      $(d).click(function(e){
            ...
            $("body").click(function(){closeselector();});
