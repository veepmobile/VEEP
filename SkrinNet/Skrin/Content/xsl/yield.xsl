...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="profile">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<thead>
					<tr>
						...
						<td class="table_caption">Дата / Период начала купонного периода</td>
						<td class="table_caption">Дата /Период окончания купонного периода</td>
						<td class="table_caption">Расчетная Дата /Срок окончания купонного периода</td>
						...
						<td class="table_caption">Текущее состояние обязательства</td>
					...
					<xsl:for-each select="issue_coupons">
						<tr>
							...
							<td>
								<table align="center">
									<tr>
										<td style="border-bottom:solid 1px #000000;width:55px;text-align:center">
							...
							<td style="text-align:center">
								<xsl:value-of disable-output-escaping="yes" select="@comm"/>
							</td>
						</tr>
					</xsl:for-each>
				</tbody>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<thead>
					<tr>
						...
						<td class="table_caption">Расчетная Дата /Срок погашения</td>
		...
		<xsl:if test="Issue_Purchases">
			<br/>
			<span class="subcaption">Предложение о выкупе  (оферта)</span>
			<br/>
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				...
				<thead>
					<tr>
						<td class="table_caption">№ </td>
						<td class="table_caption">Вид обязательства</td>
						<td class="table_caption">Расчетная Дата /Срок погашения</td>
						<td class="table_caption">Плановая  Дата  погашения</td>
						<td class="table_caption">Цена приобретения %</td>
						<td class="table_caption">Количество  приобретенных	облигаций</td>
						<td class="table_caption">Сумма обязательства</td>
						<td class="table_caption">Текущее состояние обязательства</td>
						<td class="table_caption">Фактическая дата</td>
						<td class="table_caption">Примечание</td>
				...
				<tbody>
					...
					<xsl:for-each select="Issue_Purchases">
						<tr>
							...
							<td  style="text-align:right">
								<xsl:value-of select="format-number(@redemption_amount,'# ##0.###########################','buh')"/>
							</td>
							<td  style="text-align:right">
								<xsl:value-of select="format-number(@sum_value,'# ##0.###########################','buh')"/>
							</td>
