(function () {
    ...
    function show_side_issuer(issuer_side) {
        ...
        if (issuer_side.ticker != null) {        
            if (issuer_side.profile_type == 1) {
                ...
                cell_content = '<a href=\"/profileip/' + issuer_side.ticker + '\" target=\"_blank\">' + issuer_side.name + '</a>';
            }
    ...
    window.pr_search = function (page) {
        ...
        var params = "dfrom=" + prSO.dfrom + "&dto=" + prSO.dto + "&kw=" + prSO.kw + "&job_no=" + prSO.job_no + "&ac_name=" + prSO.ac_name + "&dtype=" + prSO.dtype + "&dcateg_id=" + prSO.dcateg_id + "&iss=" + prSO.iss + "&page=" + prSO.page + "&rcount=" + prSO.rcount + "&isCompany=" + prSO.iscompany + "&rmode=" + prSO.rmode;
        $.ajax({
            url: url,
            type: "POST",
            data: params,
