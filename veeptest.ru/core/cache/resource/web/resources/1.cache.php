...
<head>  
    <base href="[[!++site_url]]">
    <title>Главная | [[+set.site-name:default=`VEEP`]]</title>
...
<div id="button-to-top" class="btn-top-top"><i class="fa fa-chevron-up"></i></div>`]]
    ...
    [[!pdoResources? 
        ...
        &includeContent=`1`
        &where=`{"parent:=":0}` 
        &includeTVs=`block-image1,block-image2,col2,title2`
        &resources=`-1,-4,-6` 
    ]]
        </main>
...
`]]
    ...
    '[[$carousel-partners]]' => '[[!pdoResources?
    &parents=`16`
    &depth=`0`
    &includeTVs=`block-image1`
    &tpl=`carousel-partners-tpl`
    &limit=`0`
    &sortdir=`ASC`
    &sortby=`menuindex`
    &toPlaceholder=`carousel-partners`
]]

[[!+carousel-partners:notempty=`
<div class="carousel-partners">
    [[+carousel-partners]]
</div>
`]]',
    '[[$map]]' => '[[!mapexMap? 
    &map=`{"coords":{"center":[55.708353999993776,37.652704999999955],"zoom":16},"type":"yandex#map","placemarks":[{"coords":[55.708354,37.652705],"params":{"iconContent":"","balloonContentBody":"","balloonContentHeader":""}}],"polygons":[],"lines":[],"routes":[]}`
    &width=`100%`
    &height=`500px`
    
    &controls=`zoomControl,mapTools,typeSelector`
]]',
  ),
  'sourceCache' => 
  array (
...
`]]',
    ...
    &width=`100%`
    &height=`500px`
    [[+set.map-icon:notempty=`&placemarkIcon=`/userfiles/[[+set.map-icon]]``]]
    &controls=`zoomControl,mapTools,typeSelector`
]]',
          'locked' => false,
          'properties' => 
