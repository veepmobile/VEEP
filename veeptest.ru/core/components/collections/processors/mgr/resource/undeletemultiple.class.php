 ...
 */
class CollectionsUnDeleteMultipleProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $lastId = $id;
            $this->modx->runProcessor('mgr/resource/undelete', array(
                'id' => $id,
                'skipClearCache' => true,
            ), array(
...
return 'CollectionsUnDeleteMultipleProcessor';