...
/**
 * Unpublish multiple children
 *
 * @package collections
 * @subpackage processors.resource
 */
class CollectionsUnPublishMultipleProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            $lastId = $id;
            $this->modx->runProcessor('mgr/resource/unpublish', array(
                'id' => $id,
                'skipClearCache' => true,
            ), array(
...
return 'CollectionsUnPublishMultipleProcessor';