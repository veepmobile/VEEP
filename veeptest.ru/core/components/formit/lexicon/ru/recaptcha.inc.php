...
$_lang['recaptcha.mailhide_no_api_key'] = 'Для использования reCAPTCHA Mailhide, вам надо получить публичный и личный ключи, это можно сделать на <a href="http://www.google.com/recaptcha">http://www.google.com/recaptcha</a>';
$_lang['recaptcha.no_api_key'] = 'Для использования reCAPTCHA вам надо получить API ключ на<a href="http://www.google.com/recaptcha">http://www.google.com/recaptcha</a>';
