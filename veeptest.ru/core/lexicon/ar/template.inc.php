...
$_lang['template_desc_description'] = 'توصيف مختصر لهذا القالب.';
$_lang['template_desc_name'] = 'اسم هذا القالب.';
...
$_lang['template_err_exists_name'] = 'يوجد مسبقا قالب يحمل الاسم  "[[name+]]".';
...
$_lang['template_icon_description'] = 'اختياري. صف رمز مخصص لكل المصادر مع هذا القالب.';
$_lang['template_lock'] = 'قفل القالب عن التعديل';
$_lang['template_lock_msg'] = 'يجب أن يكون لدى المستخدمين الواصفة edit_locked لتعديل هذا القالب.';
