 ...
 * @subpackage lexicon
 */
$_lang['alphabetically'] = 'براساس حروف الفبا';
$_lang['already_downloaded'] = 'شما هم اکنون این بسته را دریافت کرده‌اید.';
...
$_lang['by'] = 'توسط';
$_lang['changelog'] = 'پیشینه‌ی تغییرات';
...
$_lang['install'] = 'نصب';
$_lang['installation_instructions'] = 'دستورالعمل نصب';
$_lang['installed'] = 'نصب شده';
$_lang['installed_on'] = 'زمان نصب <br/>[[+time]]';
$_lang['instructions'] = 'دستورالعمل';
$_lang['last_updated'] = 'آخرین بروز رسانی';
...
$_lang['more_info'] = 'اطلاعات بیشتر';
$_lang['most_downloads'] = 'بیشترین دریافت شده‌ها';
$_lang['most_popular'] = 'محبوب‌ترین‌ها';
$_lang['name'] = 'نام';
...
$_lang['no_preview'] = 'بدون پیش‌نمایش';
$_lang['not_installed'] = 'نصب نشده است';
$_lang['package'] = 'بسته';
$_lang['package_add'] = 'افزودن بسته جدید';
...
$_lang['package_dependency_unsatisfied'] = 'بسته‌ی [[+signature]] وابسته به [[+requires]] است';
...
$_lang['provider_home_title'] = 'دریافت افزونه‌ها';
