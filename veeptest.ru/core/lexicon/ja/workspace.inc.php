...
$_lang['template_already_downloaded'] = 'テンプレートはダウンロード済みです。';
$_lang['template_preview_view'] = 'テンプレートのプレビュー：{name}';
$_lang['template_select_desc'] = '説明を見たいテンプレートを選択してください';
$_lang['templates_in_category'] = '選択したカテゴリで利用可能なテンプレートを表示。';
