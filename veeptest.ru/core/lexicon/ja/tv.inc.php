...
$_lang['tv_err_exists_name'] = '[[+name]]という名前のテンプレート変数がすでに存在します。';
...
$_lang['tv_err_save'] = 'テンプレート変数の保存中にエラーが発生しました。';
...
$_lang['tvdg_err_remove'] = 'ドキュメントグループからテンプレート変数を削除中にエラーが発生しました。';
$_lang['tvdg_err_save'] = 'ドキュメントグループにテンプレート変数を設定中にエラーが発生しました。';
$_lang['tvs'] = 'テンプレート変数';
