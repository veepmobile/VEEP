...
$_lang['login_title'] = 'Вхід до панелі управління MODX CMF';
$_lang['login_user_err_nf_email'] = 'Користувач з такою електронною адресою або іменем не знайдений. Будь ласка, спробуйте ще раз.';
