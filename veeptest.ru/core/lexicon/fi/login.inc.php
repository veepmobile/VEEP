...
$_lang['login_password_reset_act_sent'] = 'Salasanan palautus aktivointi sähköposti on lähetetty. Tarkista sähköpostisi.';
$_lang['login_remember'] = 'Muista minut';
$_lang['login_send_activation_email'] = 'Lähetä aktivointiviesti';
$_lang['login_title'] = 'Kirjautuminen MODX hallintaan';
$_lang['login_user_err_nf_email'] = 'Käyttäjää ei löydy sähköpostiosoitteella tai käyttäjätunnuksella. Yritä uudelleen.';
