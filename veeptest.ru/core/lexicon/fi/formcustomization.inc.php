...
$_lang['action_desc'] = 'Toiminto johon tämä sääntö pätee.';
$_lang['activate'] = 'Aktivoi';
$_lang['constraint'] = 'Rajaava arvo';
$_lang['constraint_class'] = 'Rajaava luokka';
...
$_lang['constraint_field'] = 'Rajaava kenttä';
...
$_lang['default_value'] = 'Oletusarvo';
$_lang['export'] = 'Vie';
$_lang['fc.action_create'] = 'Luo Resurssi';
...
$_lang['rule_description_desc'] = 'Valinnainen. Säänön kuvaus.';
...
$_lang['set_fields_msg'] = 'Tästä voit muuttaa tämän sivun kenttien asetuksia, sisältäen kentän näkyvyys, nimi ja oletusarvo. Tuplaklikkaa riviä muokataksesi sen asetuksia. Jätä kenttä tyhjäksi jos käytät oletusarvoa.';
...
$_lang['set_tabs_msg'] = 'Tässä voit säätää sivun välilehtiä ja alueita. Tuplaklikkaa riviä muokataksesi sen asetuksia. Jätä kenttä tyhjäksi jos käytät oletusarvoa.';
...
$_lang['usergroup_create'] = 'Lisää käyttäjäryhmä';
...
$_lang['usergroups'] = 'Käyttäjäryhmät';
$_lang['visible'] = 'Näkyvä';
