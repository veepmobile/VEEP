 ...
 * @subpackage lexicon
 */
$_lang['alphabetically'] = 'Aakkosjärjestyksessä';
$_lang['already_downloaded'] = 'Olet jo ladannut tämän paketin.';
$_lang['api_key'] = 'API-avain';
$_lang['author'] = 'Kehittäjä';
$_lang['autoincludes_packaging'] = 'Packaging in autoincludes: [[+autoincludes]]';
$_lang['back_to_browser'] = 'Back to Package Browser';
$_lang['back_to_manager'] = 'Palaa pakettienhallintaan';
$_lang['back_txt'] = 'Takaisin';
$_lang['breaks_at'] = 'Tukee enintään';
$_lang['by'] = 'by';
$_lang['changelog'] = 'Päivityshistoria';
...
$_lang['downloaded'] = 'Ladattu';
$_lang['downloading'] = 'Ladataan...';
$_lang['download_extras'] = 'Lataa ekstra';
$_lang['downloads'] = 'Lataukset';
$_lang['downloads_view'] = '{downloads} latausta';
$_lang['information'] = 'Tiedot';
$_lang['install'] = 'Asenna';
$_lang['installation_instructions'] = 'Asennusohjeet';
$_lang['installed'] = 'Asennettu';
$_lang['installed_on'] = 'Asennettu <br/> [[+time]]';
$_lang['instructions'] = 'Ohjeet';
$_lang['last_updated'] = 'Viimeksi päivitetty';
...
$_lang['license'] = 'Lisenssi';
$_lang['license_agree'] = 'Hyväksyn';
...
$_lang['license_disagree'] = 'En hyväksy';
$_lang['list_of_packages_in_provider'] = 'Below is a list of the packages in this provider.';
$_lang['loading'] = 'Ladataan...';
$_lang['minimum_supports'] = 'Edellyttää MODX';
$_lang['more_info'] = 'Lisätietoja';
$_lang['most_downloads'] = 'Ladatuimmat';
$_lang['most_popular'] = 'Suosituimmat';
$_lang['name'] = 'Nimi';
...
$_lang['package_add'] = 'Lisää uusi paketti';
...
$_lang['package_management'] = 'Pakettienhallinta';
$_lang['package_obtain_method'] = 'First, select how you would like to obtain the package:';
$_lang['package_preview_view'] = 'Paketin esikatselu: {name}';
$_lang['package_remove'] = 'Poista Paketti';
$_lang['package_remove_action_button'] = 'Poista';
$_lang['package_remove_confirm'] = 'Oletko varma, että haluat poistaa tämän paketin? Tämä on pysyvää.';
...
$_lang['package_remove_err_tzip'] = 'Paketin zip -tiedostoa ei voi poistaa, Tarkista oikeutesi.';
...
$_lang['package_remove_info_success'] = 'Paketti poistettu.';
...
$_lang['package_reinstall'] = 'Uudelleenasenna paketti';
$_lang['package_reinstall_action_button'] = 'Uudelleenasenna';
$_lang['package_reinstall_confirm'] = 'Oletko varma, että haluat asentaa paketin uudelleen? Tämä poistaa tekemäsi muutokset.';
$_lang['package_retriever'] = 'Paketti noutaja';
$_lang['package_search_local_title'] = 'Hae paikallisesti paketteja';
...
$_lang['package_signature'] = 'Allekirjoitus';
$_lang['package_state'] = 'Tila';
$_lang['package_uninstall'] = 'Poista Paketin asennus';
...
$_lang['package_update'] = 'Päivitä paketti';
$_lang['package_update_action_button'] = 'Päivitä';
...
$_lang['package_upload'] = 'Lataa paketti';
$_lang['package_version_remove'] = 'Poista versio';
...
$_lang['preexisting_mode_preserve'] = 'Säilytä';
...
$_lang['preexisting_mode_remove'] = 'Poista asennus';
...
$_lang['provider_home_title'] = 'Lataa ekstra';
$_lang['provider_remove'] = 'Poista toimittaja';
$_lang['provider_select'] = 'Valitse toimittaja';
$_lang['provider_select_desc'] = 'Valitse toimittaja, josta paketteja noudetaan.';
...
$_lang['provider_update'] = 'Päivitä toimittaja';
$_lang['provider_url'] = 'Palvelun URL-osoite';
$_lang['providers'] = 'Toimittajat';
...
$_lang['readme'] = 'Lue minut';
$_lang['readme_desc'] = 'Please review the README for this package.';
$_lang['released'] = 'Julkaistu';
$_lang['released_on'] = 'Julkaistiin';
...
$_lang['sort_by_dots'] = 'Lajittele...';
$_lang['supports_db'] = 'Tukee tietokantoja';
...
$_lang['top_rated'] = 'Suosituimmat';
$_lang['transport_package_create'] = 'Luo uusi pakkaus';
$_lang['transport_package_install'] = 'Asenna paketti';
$_lang['transport_package_scan_for_updates'] = 'Tarkista päivitykset';
$_lang['transport_package_upload'] = 'Lataa paketti';
$_lang['updateable'] = 'Päivityksiä saatavilla';
$_lang['uninstall'] = 'Poista asennus';
$_lang['uploaded_on'] = 'Ladattu';
$_lang['uploaded_versions'] = 'Ladatut versiot';
$_lang['username'] = 'Käyttäjätunnus';
$_lang['workspace'] = 'Työtila';
$_lang['workspace_err_nf'] = 'Työtila ei löydy.';
...
$_lang['view_details'] = 'Näytä tarkemmat tiedot';
