...
$_lang['file_create'] = 'Δημιουργία αρχείου';
$_lang['file_deleted'] = 'Success!';
$_lang['file_delete_file'] = 'Διαγραφή αρχείου';
$_lang['file_delete_folder'] = 'Διαγραφή φακέλου';
$_lang['file_download'] = 'Λήψη αρχείου';
$_lang['file_download_file'] = 'Λήψη αρχείου';
$_lang['file_download_unzip'] = 'Unzip File';
$_lang['file_edit'] = 'Επεξεργασία αρχείου';
$_lang['file_err_ae'] = 'Το αρχείο %s υπάρχει ήδη';
...
$_lang['file_err_nf'] = 'Το αρχείο δεν υπάρχει';
$_lang['file_err_ns'] = 'Please specify a valid file.';
$_lang['file_err_open'] = 'Δεν είναι εφικτό το άνοιγμα του αρχείου: ';
...
$_lang['file_folder_enter_new'] = 'Παρακαλώ εισάγετε ένα όνομα για το νέο φακέλο';
...
$_lang['file_folder_created'] = 'Ο φάκελος δημιουργήθηκε με επιτυχία';
$_lang['file_folder_deleted'] = 'Ο φάκελος διαγράφηκε με επιτυχία';
...
$_lang['file_remove'] = 'Διαγραφή αρχείου';
...
$_lang['upf_add'] = 'Προσθήκη';
$_lang['upf_add_desc'] = 'Add file into upload queue.';
$_lang['upf_close'] = 'Κλείσιμο';
...
$_lang['upload.buttons.close']            = 'Κλείσιμο';
