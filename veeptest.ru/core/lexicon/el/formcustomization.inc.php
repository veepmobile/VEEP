...
$_lang['export'] = 'Export';
$_lang['fc.action_create'] = 'Δημιουργήστε έγγραφο';
...
$_lang['set_import_template_err_nf'] = 'Πρόβλημα κάτα την εισαγωγή του Σετ Εξατομίκευσης Φόρμας: Το Πρότυπο δεν βρέθηκε.';
...
$_lang['set_edit'] = 'Τροποποίηση σετ';
