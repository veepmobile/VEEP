...
$_lang['packages_desc'] = 'Τα "Πακέτα" είναι συλλογές συστατικών του MODX, τα οποία μπορούν να χρησιμοποιηθούν με διάφορους τρόπους απ\' το πρόγραμμα. Εδώ μπορείτε να τα διαχειριστήτε, να ανανεώσετε το status εγκατάστασης, να ενεργοποιήσετε ή να απενεργοποιήσετε εγκατεστημένα πακέτα, ή να κατεβάσετε καινούρια πακέτα από εξωτερικές πηγές.';
