...
$_lang['file_browser'] = 'Πρόγραμμα περιήγησης μέσων';
$_lang['file_browser_desc'] = 'View, upload and manage media';
$_lang['flush_access'] = 'Ανανεώστε τα δικαιώματα χρήστη';
$_lang['flush_access_confirm'] = 'Είστε βέβαιοι ότι θέλετε να ανανεώσετε τα δικαιώματα χρήστη; ΣΗΜΕΙΩΣΗ: Δεν θα επηρεαστούν άλλοι χρήστες.';
$_lang['flush_access_desc'] = 'Επαναφόρτωση των δικαιωμάτων χρήστη για αυτήν τη συνεδρία';
$_lang['flush_sessions'] = 'Έξοδος όλων των χρηστών';
$_lang['flush_sessions_confirm'] = 'Είστε βέβαιοι ότι θέλετε να ανανεώσετε όλα τα δικαιώματα χρηστών; Εάν ναι, θα διαγραφούν όλες οι τρέχουσες και πρόσφατες συνδέσεις (συμπεριλαμβανομένης της δικής σας) και όλοι οι χρήστες θα αναγκαστούν να συνδεθούν ξανά.';
...
$_lang['form_customization'] = 'Προσαρμογή φόρμας';
$_lang['form_customization_desc'] = 'Create bespoke MODX Manager interfaces';
$_lang['forums'] = 'Forums';
$_lang['forums_desc'] = 'MODX Forums';
$_lang['help'] = 'Βοήθεια';
...
$_lang['new_document_desc'] = 'Δημιουργία Νέου Εγγράφου';
...
$_lang['refresh_site'] = 'Εκκαθάριση προσωρινής μνήμης';
