...
$_lang['tv_err_delete'] = 'Tekkis viga template muutuja kusutamisel.';
$_lang['tv_err_duplicate'] = 'Tekkis viga template muutuja dubleerimisel.';
...
$_lang['tv_err_exists_name'] = 'Template Muutuja nimega "[[+name]]" juba eksiteerib.';
...
$_lang['tv_err_reserved_name'] = 'Template muutuja ei saa olla sama nimega nagu on Ressurssi väli.';
$_lang['tv_err_save_access_permissions'] = 'Tekkis viga template muutuja juurdepääsu õiguste salvestamisel.';
$_lang['tv_err_save'] = 'Tekkis viga template muutuja salvestamisel.';
...
$_lang['tv_msg'] = 'Lisa või muuda template muutujaid siit. Template Muutujad tuleb sisuda templatedega, et nendele juurdepääseda snippetidest ja dokumentidest.';
...
$_lang['tv_tmpl_access_msg'] = 'Valige Templated, millel on juudepääs sellele Template Muutujale.';
$_lang['tv_widget'] = 'Widget';
$_lang['tv_widget_prop'] = 'Vidina Omadused';
$_lang['tvd_err_remove'] = 'Tekkis viga üritades eemaldada template muutujat dokumendistnt.';
$_lang['tvdg_err_remove'] = 'Tekkis viga üritades eemaldada template muutujat dokumendi grupist.';
$_lang['tvdg_err_save'] = 'Tekkis viga üritades siduda template muutujat dokumendi grupiga.';
...
$_lang['tvt_err_save'] = 'Tekkis viga üritades siduda template muutujat template-ga.';
