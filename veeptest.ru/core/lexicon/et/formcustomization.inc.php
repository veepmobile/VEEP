...
$_lang['set_fields_msg'] = 'Siit saate seadistada välju selle lehe jaoks, kaasaarvatud nende nähtavus, labelid ja vaikimisi väärtused. Tee topelt-klikk rea peal, et väärtust muuta. Jäta väli tühjaks, et kasutada vaikimisi seadet.';
...
$_lang['set_tabs_msg'] = 'Siit saate muuta selle lehe tabe, nende nähtavust ja tiitlit. Tee topelt-klikk real, et selle väärtust muuta. Jättes välja tühjaks, kasutate vaikiisi seadistust.';
