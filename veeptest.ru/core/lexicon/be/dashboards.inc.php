...
$_lang['dashboard_update'] = 'Аднавiць панэль кіравання';
...
$_lang['dashboard_err_ns_name'] = 'Калiласка, пазначце назву для вiджэта.';
...
$_lang['dashboard_widget_err_placed'] = 'Гэты віджэт ўжо змешчаны ў гэтай панэлі!';
$_lang['dashboard_widgets.intro_msg'] = 'Тут вы можаце дадаваць, кіраваць і выдаляць вiджэты для гэтай панэлі кіравання. Вы можаце перацягваць віджэты ў табліцы для змены парадку іх сартавання.';
$_lang['dashboards'] = 'Панэлі кіравання';
$_lang['dashboards.intro_msg'] = 'Тут вы можаце кіраваць усімі даступнымі панэлямі кіравання вашага мэнэджара MODX.';
$_lang['rank'] = 'Ранг';
...
$_lang['widget_err_ns_name'] = 'Калiласка, пазначце назву для вiджэта.';
...
$_lang['widget_dashboards.intro_msg'] = 'Нiжэй спіс панэляў кіравання на якіх гэты віджэт ўжываецца.';
$_lang['widget_dashboard_remove'] = 'Выдаліць віджэт з панэлі кіравання';
$_lang['widget_description_desc'] = 'Апісанне або ключ запісу слоўніка вiджэту i што ён робiць.';
...
$_lang['widget_name_desc'] = 'Назва або ключ запісу слоўніка вiджэту.';
...
$_lang['widget_namespace_desc'] = 'Прастора імёнаў, якую будзе выкарыстоўваць віджэт. Карысна для карыстальніцкіх шляхоў.';
$_lang['widget_php'] = 'Убудаваны PHP віджэт';
$_lang['widget_place'] = 'Дадаць віджэт';
$_lang['widget_size'] = 'Памер';
$_lang['widget_size_desc'] = 'Памер віджэта. Можа быць альбо ў палову шырынi экрана ("Палова"), у шырыню экрана ("Поўны") або ў поўную шырыню экрана і два радкi ("Двайны").';
...
$_lang['widget_type_desc'] = 'Віджэт тыпу "Снiпет" — гэта звычайны снiпет MODX, вынікі працы якога будуць выведзены ў віджэце. "HTML" — выведзе HTML. "Файл" — загрузiцца непасрэдна з PHP-файла, які можа альбо вярнуць свой вывад або імя modDashboardWidgetClass пашыранага класа для загрузкі. "Убудаваны PHP" выводзіць вынікі выканання PHP-кода са змесціва віджэта.';
$_lang['widget_unplace'] = 'Выдаліць віджэт з панэлі кіравання';
$_lang['widget_update'] = 'Аднавiць вiджэт';
...
$_lang['w_configcheck_desc'] = 'Выводзіць праверку канфігурацыі, што гарантуе бяспечнасць вашай устаноўкi MODX.';
