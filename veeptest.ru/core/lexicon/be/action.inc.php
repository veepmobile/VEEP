...
$_lang['action_desc'] = 'Дзеянні з\'яўляюцца абстракцыямі кантролераў MODX. Яны могуць быць выкарыстаны для стварэння карыстальнiцкiхстаронак Мэнэджара, а таксама для рэарганізацыi галоўнага меню Мэнэджара MODX.';
$_lang['action_err_create'] = 'Адбылася памылка пры стварэнні дзеяння.';
$_lang['action_err_nf'] = 'Дзеянне не знойдзена!';
$_lang['action_err_ns'] = 'Ніякіх дзеянняў пазначана!';
...
$_lang['action_update'] = 'Аднавiць дзеянне';
