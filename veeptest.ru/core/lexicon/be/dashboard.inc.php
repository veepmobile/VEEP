...
$_lang['onlineusers_message'] = 'Гэты спіс паказвае ўсіх карыстальнікаў актыўных на працягу апошніх 20 хвілін (бягучы час [[+curtime]])';
...
$_lang['security_notices'] = 'Абвяшчэнні бяспекі';
$_lang['view_tree'] = 'Паглядзець дрэва';
$_lang['welcome_back'] = 'Сардэчна запрашаем ізноў, [[+name]].';
...
$_lang['yourinfo_message'] = 'Гэты раздзел змяшчае некаторыя звесткі аб вас:';
