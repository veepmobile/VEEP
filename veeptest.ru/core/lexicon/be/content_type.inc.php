 ...
 * @subpackage lexicon
 */
$_lang['binary'] = 'Бінарны';
$_lang['binary_desc'] = 'Ці з\\\'яўляецца файл бінарным або text/ascii?';
$_lang['content_type'] = 'Тып кантэнту';
$_lang['content_type_desc'] = 'Тыпы змесціва гэта канкрэтныя тыпы файлау для вашых рэсурсаў. Тут вы можаце кіраваць імі, а таксама звязаць іх з пашырэннем файлаў.';
$_lang['content_type_err_nf'] = 'Тып змесціва не знойдзены.';
$_lang['content_type_err_nfs'] = 'Тып змесціва з ID [[+id]] не знойдзены.';
...
$_lang['content_type_err_create'] = 'Адбылася памылка пры спробе стварыць тыпу змесціва.';
$_lang['content_type_err_in_use'] = 'Вы не можаце выдаліць гэты тып змесцiва, так як ён у цяперашні час выкарыстоўваецца рэсурсамі ў MODX. Калі ласка, назначце новыя тыпы кантэнту для гэтых рэсурсаў перш чым працягнуць.';
...
$_lang['content_type_header_tab'] = 'Карыстальніцкія загалоўкі';
