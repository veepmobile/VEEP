...
$_lang['plugin_err_remove'] = 'Er is een fout opgtreden tijdens het verwijderen van deze plugin.';
...
$_lang['plugin_event_err_remove'] = 'Er is een fout opgetreden tijdens het verwijderen van de plugin gebeurtenis.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Weet je zeker dat je de plugin uit deze gebeurtenis wilt verwijderen?';
$_lang['plugin_event_update'] = 'Update plugin gebeurtenis';
$_lang['plugin_lock'] = 'Blokkeer plugin om bewerken te voorkomen';
$_lang['plugin_lock_msg'] = 'Gebruikers hebben de edit_locked attribuut nodig om deze plugin te kunnen bewerken.';
