...
$_lang['template_tv_edit'] = 'Wijzig de sortering van de template variabelen';
$_lang['template_tv_msg'] = 'De template variabelen gekoppeld aan deze template zijn hieronder weergegeven.';
$_lang['template_untitled'] = 'Naamloze template';
