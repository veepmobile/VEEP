...
$_lang['template_desc_category'] = 'Категория к которой принадлежит этот шаблон.';
$_lang['template_desc_description'] = 'Краткое описание шаблона.';
$_lang['template_desc_name'] = 'Название шаблона.';
...
$_lang['template_err_exists_name'] = 'Шаблон с именем «[[+name]]» уже существует.';
...
$_lang['template_tv_msg'] = 'Дополнительные поля, назначенные этому шаблону перечислены ниже.';
