...
$_lang['containing_panel_desc'] = 'Идентификатор панели в которой находится область. Необходим в некоторых правилах, для того что бы система могла понять в какой форме или панели находится область.';
...
$_lang['profile_err_nfs'] = 'Профиль настройки форм с идентификатором [[+id]] не найден.';
...
$_lang['profiles_msg'] = 'Это список профилей с наборами правил для настройки форм. Профиль может быть включен или выключен. Они также могут быть настроены для применения только к определенным группам пользователей.';
...
$_lang['rule_err_duplicate'] = 'Произошла ошибка при попытке коппирования правила.';
...
$_lang['set_change_template_confirm'] = 'Вы уверены, что хотите это сделать? Будет изменён шаблон, на который эти правила распространяются. Если это так, то MODX сначала сохранит изменения перед тем, как перезагрузить страницу, чтобы обновить дополнительные поля для нового шаблона.';
...
$_lang['set_err_nfs'] = 'Не найден набор с идентификатором [[+id]]';
$_lang['set_err_ns'] = 'Набор правил не указан.';
$_lang['set_fields_msg'] = 'Здесь вы можете изменить настройки стандартных полей ресурса для этого набора правил, их видимость, названия и значения по умолчанию. Дважды щелкните по строке таблицы, чтобы изменить её значения. Оставьте поле пустым для того чтобы использовать значение по умолчанию.';
$_lang['set_import_err_upload'] = 'Произошла ошибка при попытке найти XML-файл. Пожалуйста, укажите файл.';
...
$_lang['set_import_msg'] = 'Выберите XML файл для импорта из него набора правил настройки форм. It must be in the correct XML Form Customization format.';
$_lang['set_import_template_err_nf'] = 'Шаблон не найден. Импорт настроек параметров форм прерван.';
$_lang['set_msg'] = 'Здесь вы можете настроить стандартные поля, вкладки и дополнительные поля для страницы к которой применяется этот набор правил.';
$_lang['set_new'] = 'Новый набор правил';
$_lang['set_edit'] = 'Редактировать набор';
...
$_lang['set_tab_err_ae'] = 'Вкладка с этим идентификатором уже есть. Пожалуйста, укажите другой идентификатор.';
$_lang['set_tabs_msg'] = 'Здесь вы можете настроить видимость и названия вкладок для этого набора правил, так-же можно создать новые вкладки.';
...
$_lang['simplexml_err_nf'] = 'MODX требует PHP расширение SimpleXML, чтобы использовать эту функцию. Пожалуйста, убедитесь, что установлено расширение, прежде чем продолжить.';
$_lang['tab'] = 'Вкладка';
$_lang['tab_create'] = 'Создать новую вкладку';
$_lang['tab_id'] = 'ID';
$_lang['tab_name'] = 'Имя вкладки';
...
$_lang['tv_default'] = 'Значение дополнительного поля по умолчанию';
$_lang['tv_label'] = 'Заголовок дополнительного поля';
$_lang['tv_name'] = 'Имя';
$_lang['tv_move'] = 'Переместить TV во вкладку';
$_lang['tv_visible'] = 'Видимость дополнительного поля';
...
$_lang['xmlwriter_err_nf'] = 'MODX требует PHP расширение XMLWriter , чтобы использовать эту функцию. Пожалуйста, убедитесь, что установлено расширение, прежде чем продолжить.';
