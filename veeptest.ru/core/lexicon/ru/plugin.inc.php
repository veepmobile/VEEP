...
$_lang['plugin_add_to_event'] = 'Выберите события, которые должен отслеживать плагин';
...
$_lang['plugin_err_remove'] = 'Произошла ошибка при удалении плагина.';
...
$_lang['plugin_event_err_remove'] = 'При удалении системного события плагина произошла ошибка.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Вы уверены, что хотите удалить отслеживание плагином этого системного события?';
$_lang['plugin_event_update'] = 'Обновить системные события плагина';
$_lang['plugin_lock'] = 'Плагин закрыт для редактирования';
