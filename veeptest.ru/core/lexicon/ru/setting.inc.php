...
$_lang['setting_friendly_alias_realtime_desc'] = 'Определяет, должен ли псевдоним ресурса создаваться «на лету» при вводе заголовка или, если указан <b>automatic_alias</b>, когда ресурс сохраняется.';
...
$_lang['setting_modx_browser_tree_hide_tooltips_desc'] = 'Если параметр включен, при наведении курсора на файл изображения всплывающее окно предпросмотра отображаться не будет.';
...
$_lang['setting_parser_recurse_uncacheable_desc'] = 'Если отключено, некешируемые элементы могут показывать кешированное содержимое внутри кешированных элементов. Отключайте ТОЛЬКО если у вас есть проблемы со сложным вложенным парсингом, который перестал работать как ожидалось.';
...
$_lang['setting_phpthumb_nohotlink_erase_image'] = 'Удалять изображения при включенном Hotlinking';
$_lang['setting_phpthumb_nohotlink_erase_image_desc'] = 'Сообщает, когда нельзя удалить изображение, сгенерированно на удаленном сервере.';

$_lang['setting_phpthumb_nohotlink_text_message'] = 'Сообщение о запрете Hotlinking';
...
$_lang['setting_phpthumb_nohotlink_valid_domains'] = 'Допустимые домены для Hotlinking';
...
$_lang['setting_phpthumb_nooffsitelink_enabled'] = 'Запрещать внешние ссылки';
$_lang['setting_phpthumb_nooffsitelink_enabled_desc'] = 'Запрещает другим использовать phpThumb для отрисовки изображений на их собственных сайтах.';

$_lang['setting_phpthumb_nooffsitelink_erase_image'] = 'Удалять изображения по внешним ссылкам';
...
$_lang['setting_phpthumb_nooffsitelink_require_refer'] = 'Требовать указание referrer для внешних подключений';
...
$_lang['setting_phpthumb_nooffsitelink_text_message'] = 'Сообщение о недоступности внешних ссылок';
...
$_lang['setting_phpthumb_nooffsitelink_valid_domains'] = 'Допустимые домены для внешних ссылок';
...
$_lang['setting_phpthumb_nooffsitelink_watermark_src'] = 'Адрес водяного знака для внешних запросов';
$_lang['setting_phpthumb_nooffsitelink_watermark_src_desc'] = 'Необязательно. Допустимый путь к файлу, который будет использоваться в качестве водяного знака, когда ваши изображения отображаются вне сайта.';
...
$_lang['setting_resource_tree_node_name_fallback_desc'] = 'Укажите поле ресурса для использования в качестве запасного варианта при отрисовке узлов в дереве ресурсов. Это значение будет использоваться, если ресурс имеет пустое значение для заданного поля ресурса в дереве.';
...
$_lang['setting_syncsite_default_desc'] = 'Если параметр включен, кэш будет очищаться автоматически при сохранении.';
$_lang['setting_syncsite_default_err'] = 'Пожалуйста, укажите, хотите ли вы, чтобы кэш очищался по умолчанию при сохранении ресурса.';
...
$_lang['setting_welcome_action_desc'] = 'Контроллер по умолчанию при входе в админку в случае, когда контроллер не задан в URL.';
