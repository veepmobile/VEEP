...
$_lang['dashboard_add'] = 'Dodaj Kokpit';
$_lang['dashboard_create'] = 'Utwórz Kokpit';
$_lang['dashboard_desc_name'] = 'Nazwa Kokpitu.';
$_lang['dashboard_desc_description'] = 'Krótki opis Kokpitu.';
$_lang['dashboard_desc_hide_trees'] = 'Zaznacz, aby po zalogowaniu Kokpit był widoczny na całej szerokości ekranu.';
$_lang['dashboard_hide_trees'] = 'Ukryj drzewo po lewej stronie';
$_lang['dashboard_duplicate'] = 'Duplikuj Kokpit';
$_lang['dashboard_remove'] = 'Usuń Kokpit';
$_lang['dashboard_remove_confirm'] = 'Czy na pewno chcesz usunąć ten Kokpit?';
$_lang['dashboard_remove_multiple'] = 'Remove Dashboards';
$_lang['dashboard_remove_multiple_confirm'] = 'Czy na pewno chcesz usunąć zaznaczone Kokpity?';
$_lang['dashboard_update'] = 'Edytuj Kokpit';
$_lang['dashboard_err_ae_name'] = 'Kokpit o nazwie "[[+ nazwa]]" już istnieje! Wpisz inną nazwę.';
$_lang['dashboard_err_duplicate'] = 'Wystąpił błąd podczas próby powielenia kokpitu.';
$_lang['dashboard_err_nf'] = 'Kokpitu nie znaleziono.';
$_lang['dashboard_err_ns'] = 'Dashboard not specified.';
$_lang['dashboard_err_ns_name'] = 'Please specify a name for the widget.';
$_lang['dashboard_err_remove'] = 'Wystąpił błąd podczas próby usunięcia Kokpitu.';
$_lang['dashboard_err_remove_default'] = 'Nie można usunąć domyślnego Kokpitu!';
$_lang['dashboard_err_save'] = 'Wystąpił błąd podczas próby zapisania Kokpitu.';
$_lang['dashboard_usergroup_add'] = 'Przypisz Kokpit do Grupy Użytkowników';
$_lang['dashboard_usergroup_remove'] = 'Usuń przypisanie Kokpitu do Grupy';
$_lang['dashboard_usergroup_remove_confirm'] = 'Czy na pewno chcesz przypisać domyślny Kokpit tej Grupie Użytkowników?';
$_lang['dashboard_usergroups.intro_msg'] = 'Oto Grupy Użytkowników przypisane do tego Kokpitu.';
