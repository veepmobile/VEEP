...
$_lang['snippet_desc_category'] = 'Den kategori som denna snippet hör till.';
$_lang['snippet_desc_description'] = 'En kort beskrivning av denna snippet.';
$_lang['snippet_desc_name'] = 'Snippetens namn. Den blir tillgänglig genom att använda [[SnippetNamn]]-taggar.';
...
$_lang['snippet_err_exists_name'] = 'Det finns redan en snippet med namnet "[[+name]]".';
...
$_lang['snippet_lock_msg'] = 'Användare måste ha attributet edit_locked för att kunna redigera denna snippet.';
$_lang['snippet_management_msg'] = 'Här kan du skapa nya snippets eller välja en redan befintlig för redigering.';
$_lang['snippet_msg'] = 'Här kan du skapa och redigera snippets. Kom ihåg att snippets är "rå" PHP-kod, och om du vill att snippeten ska skriva något i mallen, så måste ett värde returneras från snippeten.';
