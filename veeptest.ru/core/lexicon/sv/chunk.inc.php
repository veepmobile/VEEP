 ...
 */
$_lang['chunk'] = 'Chunk';
$_lang['chunk_desc_category'] = 'Kategorin som denna chunk hör till.';
$_lang['chunk_desc_description'] = 'En kort beskrivning av denna chunk.';
$_lang['chunk_desc_name'] = 'Chunkens namn. Den blir tillgänglig genom att använda [[$chunkensNamn]]-taggar.';
...
$_lang['chunk_err_create'] = 'Ett fel inträffade när en ny chunk skulle skapas.';
...
$_lang['chunk_msg'] = 'Här kan du skapa och redigera chunks. Kom ihåg att chunks är "rå" HTML-kod, så PHP-kod kommer inte att tolkas.';
$_lang['chunk_name'] = 'Chunk-namn';
