...
$_lang['plugin_add_to_event'] = 'Lägg till plugin till händelse';
$_lang['plugin_code'] = 'Plugin-kod (php)';
$_lang['plugin_config'] = 'Konfigurera plugin';
$_lang['plugin_desc'] = 'Beskrivning';
$_lang['plugin_desc_category'] = 'Den kategori som denna plugin hör till.';
...
$_lang['plugin_event_err_remove'] = 'Ett fel inträffade när pluginhändelsen skulle tas bort.';
...
$_lang['plugin_event_update'] = 'Uppdatera pluginhändelse';
$_lang['plugin_lock'] = 'Lås plugin för redigering';
$_lang['plugin_lock_msg'] = 'Användare måste ha attributet edit_locked för att kunna redigera denna plugin.';
