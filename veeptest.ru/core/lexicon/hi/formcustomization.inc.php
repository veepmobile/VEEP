...
$_lang['set_fields_msg'] = 'यहाँ आप उनकी दृश्यता, लेबल और मूलभूत मूल्यों सहित इस पेज के लिए क्षेत्रों को समायोजित कर सकते हैं। बस अपने मूल्य को संपादित करने के लिए एक पंक्ति पर डबल क्लिक करें। डिफ़ॉल्ट सेटिंग का उपयोग करने के लिए खाली एक क्षेत्र छोड़ दें।';
...
$_lang['set_tabs_msg'] = 'यहाँ आप टैब्स और क्षेत्रों सहित उनकी दृश्यता और शीर्षक इस पृष्ठ के लिए समायोजित करें। सिर्फ एक पंक्ति पर इसका मान को संपादित करने के लिए डबल-क्लिक करें। एक फ़ील्ड डिफ़ॉल्ट सेटिंग का उपयोग करने के लिए खाली छोड़ दें।';
