...
$_lang['template_already_downloaded'] = 'पहले से ही डाउनलोड टेम्पलेट';
$_lang['template_preview_view'] = 'टेम्पलेट पूर्वावलोकन: {name}';
$_lang['template_select_desc'] = 'इसके विवरण देखने के लिए किसी टेम्पलेट का चयन करें...';
$_lang['templates_in_category'] = 'चयनित Category में उपलब्ध टेम्पलेट्स देख रहे हैं वो।';
