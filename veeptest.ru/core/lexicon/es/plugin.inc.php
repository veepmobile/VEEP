...
$_lang['plugin_add_to_event'] = 'Añadir Plugin a Evento';
$_lang['plugin_code'] = 'Código del Plugin (php)';
$_lang['plugin_config'] = 'Configuración del Plugin';
$_lang['plugin_desc'] = 'Descripción';
$_lang['plugin_desc_category'] = 'La Categoría a la que pertenece este Plugin.';
$_lang['plugin_desc_description'] = 'Breve descripción del Plugin.';
$_lang['plugin_desc_name'] = 'El nombre de este Plugin.';
...
$_lang['plugin_err_remove'] = 'Ocurrió un error mientras se eliminaba el plugin.';
...
$_lang['plugin_event_err_remove'] = 'Ocurrió un error mientras se eliminaba el evento del plugin.';
...
$_lang['plugin_lock'] = 'Bloquear plugin para edición';
...
$_lang['plugin_msg'] = 'Aquí se pueden añadir/editar plugins. Los plugins son código de PHP "puro" que son invocados cuando los se lanzan los Eventos del Sistema seleccionados.';
$_lang['plugin_name'] = 'Nombre del Plugin';
$_lang['plugin_new'] = 'Plugin Nuevo';
...
$_lang['plugin_untitled'] = 'Plugin sin Título';
