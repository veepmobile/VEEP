...
$_lang['snippet_desc_category'] = 'La Categoría a la que pertenece el Snippet.';
$_lang['snippet_desc_description'] = 'Breve descripción del Snippet.';
$_lang['snippet_desc_name'] = 'El nombre del Snippet. Estará disponible usando la etiqueta [[NameOfSnippet]].';
...
$_lang['snippet_err_exists_name'] = 'Ya existe un snippet con el nombre "[[+name]]".';
...
$_lang['snippet_err_remove'] = 'Ocurrió un error mientras se eliminaba el snippet.';
...
$_lang['snippet_lock_msg'] = 'Los usuarios deben poseer el permiso "edit_locked" para poder editar este snippet.';
$_lang['snippet_management_msg'] = 'Aquí se puede escoger el snippet a editar.';
$_lang['snippet_msg'] = 'Aquí se pueden añadir/editar snippets. Recuerda que los snippets son código PHP, y para que la salida del snippet sea mostrada en la plantilla, se necesita retornar un valor desde dentro del snippet.';
$_lang['snippet_name'] = 'Nombre del Snippet';
$_lang['snippet_new'] = 'Snippet Nuevo';
$_lang['snippet_properties'] = 'Propiedades Prefijadas';
$_lang['snippet_title'] = 'Crear/editar snippet';
$_lang['snippet_untitled'] = 'Snippet sin nombre';
