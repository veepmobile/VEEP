...
$_lang['tv_err_delete'] = 'Ocurrió un error mientras se borraba la variable de plantilla.';
$_lang['tv_err_duplicate'] = 'Ocurrió un error mientras se trataba de duplicar la variable de plantilla.';
$_lang['tv_err_duplicate_templates'] = 'Ocurrió un error mientras se duplicaban las plantillas de Variable de Plantilla.';
$_lang['tv_err_duplicate_documents'] = 'Ocurrió un error mientras se duplicaban los documentos de Variable de Plantilla.';
$_lang['tv_err_duplicate_documentgroups'] = 'Ocurrió un error mientras se duplicaban los grupos de documentos de Variable de Plantilla.';
$_lang['tv_err_exists_name'] = 'Ya existe una Variable de Plantilla con el nombre "[[+name]]".';
...
$_lang['tv_err_reserved_name'] = 'Una variable de plantilla no puede tener el mismo nombre que un campo de Recurso.';
$_lang['tv_err_save_access_permissions'] = 'Ocurrió un error mientras se intentaban guardar los permisos de acceso a la variable de plantilla.';
$_lang['tv_err_save'] = 'Ocurrió un error mientras se guardaba la variable de plantilla.';
$_lang['tv_inuse'] = 'Los siguientes documentos utilizan actualmente esta Variable de Plantilla. Para continuar con la operación de borrado haz click en el botón de Borrar, por el contrario, haz click en el botón de Cancelar.';
...
$_lang['tv_management_msg'] = 'Administrar campos de contenido adicional personalizados (Variables de Plantilla) para los documentos.';
$_lang['tv_msg'] = 'Añade o edita variables de plantilla aquí. Las Variables de Plantilla deben ser asignadas a plantillas para que sean accesibles desde snippets y documentos.';
...
$_lang['tv_tmpl_access_msg'] = 'Seleciona las Plantillas que tienen acceso a esta Variable de Plantilla.';
$_lang['tv_widget'] = 'Widget';
$_lang['tv_widget_prop'] = 'Propiedades del Widget';
$_lang['tvd_err_remove'] = 'Ocurrió un error mientras se trataba de eliminar la variable de plantilla del documento.';
$_lang['tvdg_err_remove'] = 'Ocurrió un error mientras se trataba de eliminar la variable de plantilla del grupo de documentos.';
$_lang['tvdg_err_save'] = 'Ocurrió un error mientras se trataba de asignar la variable de plantilla al grupo de documentos.';
$_lang['tvs'] = 'Variables de Plantilla';
$_lang['tvt_err_nf'] = 'La Variable de Plantilla no tiene acceso a la Plantilla especificada.';
$_lang['tvt_err_remove'] = 'Ocurrió un error mientras se trataba de eliminar la variable de plantilla de la plantilla.';
$_lang['tvt_err_save'] = 'Ocurrió un error mientras se trataba de asignar la variable de plantilla a la plantilla.';
