...
$_lang['chunk_lock_msg'] = 'Benutzer müssen das Attribut edit_locked besitzen, um diesen Chunk bearbeiten zu können.';
$_lang['chunk_msg'] = 'Hier können Sie Chunks erstellen/bearbeiten. Denken Sie daran: Chunks bestehen aus reinem HTML-Quelltext; jeglicher enthaltener PHP-Code wird nicht verarbeitet.';
$_lang['chunk_name'] = 'Chunk-Name';
$_lang['chunk_new'] = 'Neuer Chunk';
