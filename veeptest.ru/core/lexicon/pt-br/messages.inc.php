 ...
 */
$_lang['all'] = 'Todos';
$_lang['date_sent'] = 'Data de envio';
$_lang['forward'] = 'Encaminhar';
$_lang['mark_unread'] = 'Marcar não lidas';
$_lang['message'] = 'Mensagem';
$_lang['message_create'] = 'Criar Mensagem';
$_lang['message_new'] = 'Nova Mensagem';
$_lang['message_remove_confirm'] = 'Tem certeza que deseja remover esta mensagem completamente?';
$_lang['messages'] = 'Mensagens';
$_lang['private'] = 'Privado';
$_lang['read'] = 'Ler';
$_lang['recipient'] = 'Destinatário';
$_lang['recipient_type'] = 'Tipo de Destinatário';
$_lang['reply'] = 'Responder';
$_lang['role'] = 'Função';
$_lang['sender'] = 'Remetente';
$_lang['sent_by'] = 'Enviada por';
$_lang['sent_on'] = 'Enviado em';
$_lang['subject'] = 'Assunto';
$_lang['user'] = 'Usuário';
$_lang['usergroup'] = 'Grupo de Usuário';

$_lang['message_err_nfs'] = 'Mensagem não foi encontrado.';
...
$_lang['message_send_email'] = 'Enviar E-mail';
