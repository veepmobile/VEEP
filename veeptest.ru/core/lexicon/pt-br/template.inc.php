...
$_lang['template_err_delete'] = 'Ocorreu um erro ao excluir o template.';
$_lang['template_err_duplicate'] = 'Ocorreu um erro durante a duplicação do template.';
$_lang['template_err_exists_name'] = 'O template já existe com o nome de "[[+name]]".';
...
$_lang['template_tv_edit'] = 'Editar a ordem de classificação das variáveis ​​do template';
$_lang['template_tv_msg'] = 'As Variáveis de Template atribuídos a este template estão listados abaixo.';
