...
$_lang['plugin_add_to_event'] = 'Adicionar Plugin para o Evento';
$_lang['plugin_code'] = 'Código do Plugin (php)';
$_lang['plugin_config'] = 'Configuração do Plugin';
$_lang['plugin_desc'] = 'Descrição';
$_lang['plugin_desc_category'] = 'A categoria que o Plugin pertence ';
$_lang['plugin_desc_description'] = 'Uma breve descrição deste Plugin.';
$_lang['plugin_desc_name'] = 'O nome deste Plugin.';
$_lang['plugin_delete_confirm'] = 'Tem certeza de que deseja excluir este plugin?';
$_lang['plugin_disabled'] = 'Plugin Desativado';
...
$_lang['plugin_err_remove'] = 'Ocorreu um erro ao remover o plugin.';
...
$_lang['plugin_event_err_remove'] = 'Ocorreu um erro ao remover o evento plugin.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Você tem certeza que deseja remover este plugin deste evento?';
$_lang['plugin_event_update'] = 'Atualizar Evento';
$_lang['plugin_lock'] = 'Trancar plugin para edição';
$_lang['plugin_lock_msg'] = 'Os usuários devem ter o atributo edit_locked para editar este plugin.';
...
$_lang['plugin_untitled'] = 'Plugin sem título';
