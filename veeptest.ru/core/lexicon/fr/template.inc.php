...
$_lang['template_msg'] = 'Créer et modifier des modèles. Les nouveaux modèles et les modèles modifiés ne seront pas visibles dans les pages mises en cache de votre site tant que le cache n\'est pas vidé. Cependant, vous pouvez utiliser la fonction de prévisualisation pour voir le modèle en action';
$_lang['template_name'] = 'Nom du modèle';
$_lang['template_new'] = 'Nouveau modèle';
...
$_lang['template_tv_edit'] = 'Modifier l\'ordre de tri des variables de modèles';
$_lang['template_tv_msg'] = 'Les variables de modèles assignées à ce modèle sont listées ci-dessous :';
