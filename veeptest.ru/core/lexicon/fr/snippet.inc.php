...
$_lang['snippet_desc_category'] = 'La catégorie à laquelle appartient ce Snippet.';
$_lang['snippet_desc_description'] = 'Courte description du Snippet.';
$_lang['snippet_desc_name'] = 'Nom du Snippet, qui sera disponible en utilisant le tag [[NomDuSnippet]].';
...
$_lang['snippet_err_exists_name'] = 'Un snippet ayant pour nom "[[+name]]" existe déjà.';
...
$_lang['snippet_msg'] = 'Créez et modifiez ici des Snippets. Rappelez-vous, les Snippets sont des code PHP "brut", et si vous souhaitez que la sortie du Snippet s\'affiche à un certain emplacement de vos Templates, vous devez retourner une valeur à partir du Snippet.';
