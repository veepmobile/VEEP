...
$_lang['plugin_desc_category'] = 'La catégorie à laquelle appartient ce plugin.';
$_lang['plugin_desc_description'] = 'Courte description du plugin.';
$_lang['plugin_desc_name'] = 'Nom du plugin.';
...
$_lang['plugin_err_exists_name'] = 'Un plugin ayant pour nom "[[+name]]" existe déjà.';
...
$_lang['plugin_err_remove'] = 'Une erreur s\'est produite lors de la suppression du plugin.';
...
$_lang['plugin_event_err_remove'] = 'Une erreur s\'est produite en voulant retirer l\'événement du plugin.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Voulez-vous vraiment retirer le plugin de cet événement?';
$_lang['plugin_event_update'] = 'Mise à jour de l\'événement de ce plugin';
$_lang['plugin_lock'] = 'Verrouiller le plugin contre les modifications';
$_lang['plugin_lock_msg'] = 'Les utilisateurs doivent posséder l\'attribut edit_locked pour modifier ce plugin.';
...
$_lang['plugin_untitled'] = 'Plugin sans nom';
