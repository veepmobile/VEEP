...
$_lang['tv_err_exists_name'] = 'Une variable de modèle ayant pour nom "[[+name]]" existe déjà.';
$_lang['tv_err_invalid_name'] = 'Il y a des caractères invalides dans le nom de la Variable de Modèle.';
$_lang['tv_err_locked'] = 'Variable de modèle verrouillée !';
$_lang['tv_err_nf'] = 'Variable de modèle non trouvée.';
$_lang['tv_err_nfs'] = 'Variable de modèle non trouvée avec la clé : [[+id]]';
$_lang['tv_err_ns'] = 'Variable de modèle non spécifiée.';
$_lang['tv_err_reserved_name'] = 'Une variable de modèle ne peut avoir le même nom qu\'un champ de Ressource.';
$_lang['tv_err_save_access_permissions'] = 'Une erreur est apparue en essayant de sauvegarder les permissions d\'accès à la variable de modèle.';
$_lang['tv_err_save'] = 'Une erreur est apparue lors de la sauvegarde de la variable de modèle.';
$_lang['tv_inuse'] = 'Les documents suivants utilisent actuellement cette Variable de Modèle. Pour continuer l\'opération de suppression cliquez sur le bouton Supprimer, sinon cliquez sur le bouton Annuler.';
$_lang['tv_input_options'] = 'Options d\'entrée';
$_lang['tv_input_options_msg'] = '<p>Vous pouvez éditer ici les options d\'entrée pour la variable de modèle, propre au type de variable que vous avez choisi.</p>';
$_lang['tv_lock'] = 'Variable verrouillée';
$_lang['tv_lock_msg'] = 'Les utilisateurs doivent avoir l\'attribut edit_locked pour éditer cette Variable de Modèle.';
...
$_lang['tv_sources.intro_msg'] = 'Définissez ici quels Media Sources sont utilisés pour cette TV, et dans quel contexte. Double-cliquez sur le nom de la source pour le modifier.';
$_lang['tv_tmpl_access'] = 'Accès au Modèle';
$_lang['tv_tmpl_access_msg'] = 'Sélectionnez les Modèles autorisés à accéder à cette Variable de Modèle.';
