...
$_lang['plugin_add_to_event'] = 'Tilføj plugin til event';
$_lang['plugin_code'] = 'Plugin-kode (PHP)';
$_lang['plugin_config'] = 'Plugin-konfiguration';
$_lang['plugin_desc'] = 'Beskrivelse';
$_lang['plugin_desc_category'] = 'Kategorien dette plugin hører til i.';
$_lang['plugin_desc_description'] = 'En kort beskrivelse af dette plugin.';
$_lang['plugin_desc_name'] = 'Navnet på dette plugin.';
...
$_lang['plugin_err_remove'] = 'Der opstod en fejl under sletningen af dette plugin.';
...
$_lang['plugin_event_err_remove'] = 'Der opstod en fejl under fjernelse af plugin-event.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Er du sikker på du vil fjerne dette plugin fra denne event?';
$_lang['plugin_event_update'] = 'Opdatér plugin-event';
$_lang['plugin_lock'] = 'Lås plugin for redigering';
$_lang['plugin_lock_msg'] = 'Brugere skal have rettighed til egenskaben "edit_locked" for at redigere dette plugin.';
...
$_lang['plugin_msg'] = 'Her kan du tilføje/redigere plugins. Plugins er \'rå\' PHP kode som aktiveres når de valgte systemevents er udløst.';
$_lang['plugin_name'] = 'Pluginnavn';
$_lang['plugin_new'] = 'Nyt plugin';
