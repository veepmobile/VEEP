...
$_lang['tv_default_desc'] = 'Стойността по подразбиране, която тази TV ще има, ако не е зададена друга.';
$_lang['tv_elements'] = 'Опции за въвеждащи стойности';
$_lang['tv_elements_desc'] = 'Опции на стойности за  TVs с множество опции за избор, като падащо или избираем таг (разделете опциите с || ).';
