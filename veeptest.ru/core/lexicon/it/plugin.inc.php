...
$_lang['plugin_add_to_event'] = 'Aggiungi Plugin a un Evento';
$_lang['plugin_code'] = 'Codice Plugin (php)';
$_lang['plugin_config'] = 'Configurazione Plugin';
$_lang['plugin_desc'] = 'Descrizione';
$_lang['plugin_desc_category'] = 'La Categoria a cui appartiene questo Plugin.';
$_lang['plugin_desc_description'] = 'Una breve descrizione di questo Plugin.';
$_lang['plugin_desc_name'] = 'Il nome di questo Plugin.';
...
$_lang['plugin_err_remove'] = 'Si è verificato un errore durante la rimozione del plugin.';
...
$_lang['plugin_event_err_remove'] = 'Si è verificato un errore durante la rimozione dell\'evento del plugin.';
...
$_lang['plugin_event_plugin_remove_confirm'] = 'Sei sicuro di voler rimuovere questo plugin da questi eventi?';
$_lang['plugin_event_update'] = 'Aggiornamento Evento Plugin';
$_lang['plugin_lock'] = 'Blocca Modifiche Plugin';
$_lang['plugin_lock_msg'] = 'Se selezionato, gli utenti devono avere i permessi di "modifica bloccati" (edit_locked) per modificare questo Plugin.';
...
$_lang['plugin_msg'] = 'Qui puoi aggiungere/modificare i plugins. I Plugins sono codice PHP grezzo (\'raw\'), che vengono richiamati ogni volta che sono attivati i relativi eventi di sistema.';
$_lang['plugin_name'] = 'Nome Plugin';
$_lang['plugin_new'] = 'Nuovo Plugin';
...
$_lang['plugin_untitled'] = 'Plugin senza titolo';
