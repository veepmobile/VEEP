...
$_lang['set_tabs_msg'] = 'Qui puoi impostare le schede (tabs) per questa pagina, compresa la loro visibilità ed il loro titolo. E\' sufficiente un doppio click su una riga per modificare il suo valore. Lascia un campo vuoto per usare le impostazioni di default.';
