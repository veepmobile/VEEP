...
namespace RestService.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public ActionResult LogReport()
        {
            ...
            // Фильтр
            LogFilters filter = new LogFilters();
        ...
        [HttpPost]
        public ActionResult LogReportLoad(LogFilters filter)
        {
            ViewBag.Filter = filter;
            Session["Filters"] = filter;
            ViewBag.Title = "Отчеты: Лог";
            ...
            try
            {
                List<ReportLog> report = new List<ReportLog>();
                report = ReportData.GetLogReport(begindate, enddate);
                if (report != null)
                {
                    Session["report_main"] = report;
